...
func (s *HashiHandlerTestSuite) Test_HandleEvents_ValidMessage() {
	...
	err := s.hashiHandler.HandleEvents(s.destinationDomain, big.NewInt(80), big.NewInt(100), big.NewInt(150))
