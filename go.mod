module github.com/sygmaprotocol/sygma-inclusion-prover
...
replace github.com/attestantio/go-eth2-client => github.com/mpetrun5/go-eth2-client v0.0.0-20241107134000-163a867aa545
